...
class FormFieldWidget extends StatelessWidget {
  ...
  final int? maxLines;
  EdgeInsets? contentPadding = EdgeInsets.all(15 * SizeConfig.heightMultiplier!);
        ...
        children: [
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8 * SizeConfig.heightMultiplier!), borderSide: const BorderSide(color: Colors.transparent)),
              enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8 * SizeConfig.heightMultiplier!), borderSide: const BorderSide(color: Colors.transparent)),
              errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8 * SizeConfig.heightMultiplier!), borderSide: const BorderSide(color: Colors.transparent)),
              disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8 * SizeConfig.heightMultiplier!), borderSide: const BorderSide(color: Colors.transparent)),
              focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8 * SizeConfig.heightMultiplier!), borderSide: const BorderSide(color: Colors.transparent)),
              filled: true,
